...
export class DepartamentoCiudadController {
  ...
  async find(
    ...
    return this.departamentoRepository.ciudad(id).find(filter);
  }
  ...
  async create(
    ...
    return this.departamentoRepository.ciudad(id).create(ciudad);
  }
  ...
  async patch(
    ...
    return this.departamentoRepository.ciudad(id).patch(ciudad, where);
  }
  ...
  async delete(
    ...
    return this.departamentoRepository.ciudad(id).delete(where);
  }
}
